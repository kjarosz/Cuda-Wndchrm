...
float grey_value(float value)
{
   ...
   return((float)(1-((value-GREY_MAX)/(GREY_END-GREY_MAX))));
}
...
float almost_grey_value(float value)
{
   ...
   return((float)(1-((value-ALMOST_GREY_MAX)/(ALMOST_GREY_END-ALMOST_GREY_MAX))));
}
...
float tend_clear_value(float value)
{
   ...
   return((float)(1-((value-TEND_CLEAR_MAX)/(TEND_CLEAR_END-TEND_CLEAR_MAX))));
}
...
float clear_value(float value)
{
   ...
   return((float)(1-((value-CLEAR_MAX)/(CLEAR_END-CLEAR_MAX))));
}
...
float dark_value(float value)
{
   ...
   if (value<DARK_MAX) return((float)((value-DARK_START)/(DARK_MAX-DARK_START)));
   else
   return((float)(1-((value-DARK_MAX)/(DARK_END-DARK_MAX))));
}
...
float almost_dark_value(float value)
{
   ...
   return((float)(1-((value-ALMOST_DARK_MAX)/(ALMOST_DARK_END-ALMOST_DARK_MAX))));
}
...
float tend_dark_value(float value)
{
   ...
   if (value<TEND_DARK_MAX) return((float)((value-TEND_DARK_START)/(TEND_DARK_MAX-TEND_DARK_START)));
   else
   return((float)(1-((value-TEND_DARK_MAX)/(TEND_DARK_END-TEND_DARK_MAX))));
}
...
float hue_red_value(float value)
{
   ...
   if (value<HUE_RED_MAX) return((float)((value-HUE_RED_START)/(HUE_RED_MAX-HUE_RED_START)));
   else
   return((float)(1-((value-HUE_RED_MAX)/(HUE_RED_END-HUE_RED_MAX))));
}
...
float hue_yellow_value(float value)
{
   ...
   return((float)(1-((value-HUE_YELLOW_MAX)/(HUE_YELLOW_END-HUE_YELLOW_MAX))));
}
//---------------------------------------------------------------------------
...
{  double max_membership,membership;
   ...
   {  membership=CalculateRules2(hue,saturation,value,color_index);
      if (color_certainties) color_certainties[color_index]=(float)membership;
